...
public class EastPanel extends JPanel {
    ...
    /**
     * Returns the number of infected humans.
     * 
     * @return myInfectedHumans the number of infected humans
     * @custom.post the number of infected humans is returned
     */
    public int getMyInfectedHumans() {
        return myInfectedHumans;
    }

    /**
     * Returns the number of healthy humans.
     * 
     * @return myHealthyHumans the number of healthy humans
     * @custom.post the number of healthy humans is returned
     */
    public int getMyHealthyHumans() {
        return myHealthyHumans;
    }

    /**
     * Returns the number of infected birds.
     * 
     * @return myInfectedHumans the number of infected birdss
     * @custom.post the number of infected birds is returned
     */
    public int getMyInfectedBirds() {
        return myInfectedBirds;
    }

    /**
     * Returns the number of healthy birds.
     * 
     * @return myInfectedHumans the number of healthy birds
     * @custom.post the number of healthy birds is returned
     */
    public int getMyHealthyBirds() {
        return myHealthyBirds;
    }
}
